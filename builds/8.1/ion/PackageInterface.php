...
interface PackageInterface
{
     ...
     */
    static function create(string $vendor, string $project, bool $requireOnly = true, callable $loadingHandler = null, string $projectRootFile = null, SemVerInterface $version = null, int $requiredPhpMajorVersion = null, int $requiredPhpMinorVersion = null) : PackageInterface;
    /**
     *
