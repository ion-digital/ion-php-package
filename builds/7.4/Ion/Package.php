...
final class Package extends Disposable implements PackageInterface
{
     ...
     */
    public static function create(string $vendor, string $project, callable $handler = null, string $projectRootFile = null, bool $requireOnly = true, SemVerInterface $version = null, int $requiredPhpMajorVersion = null, int $requiredPhpMinorVersion = null, SettingsProviderInterface ...$settingsProviders) : PackageInterface
    {
        if (static::hasInstance($vendor, $project)) {
            return static::getInstance($vendor, $project);
        }
        return new static($vendor, $project, $handler ?? function (PackageInterface $package) use($vendor, $project) : void {
            ...
            require_once $rf;
        }, $projectRootFile ?? static::getCallingFile(), $requireOnly, $version, $requiredPhpMajorVersion, $requiredPhpMinorVersion, ...$settingsProviders);
    ...
    private $disposables = [];
    protected function __construct(string $vendor, string $project, callable $handler, string $projectRootFile, bool $requireOnly, SemVerInterface $version = null, int $requiredPhpMajorVersion = null, int $requiredPhpMinorVersion = null, SettingsProviderInterface ...$settingsProviders)
    {
        ...
        if ($requiredPhpMajorVersion !== null) {
            $requiredPhpVersion = new SemVer($requiredPhpMajorVersion, $requiredPhpMinorVersion ?? 0);
