...
class Settings implements SettingsInterface, ArrayAccess
{
    ...
    protected final function get(string $name, $default = null)
    {
    ...
    protected final function set(string $name, $value = null) : SettingsInterface
    {
    ...
    public final function getAsBool(string $name, bool $default = false) : bool
    {
        return boolval($this->get($name, $default));
    }
    public final function getAsString(string $name, string $default = '') : string
    {
        return (string) $this->get($name, $default);
    }
    public final function getAsInt(string $name, int $default = 0) : int
    {
        return intval($this->get($name, $default));
    }
    public final function getAsFloat(string $name, float $default = 0.0) : float
    {
        return floatval($this->get($name, $default));
    }
    public final function getAsArray(string $name, array $default = []) : array
    {
    ...
    public final function getSection(string $name) : SettingsInterface
    {
