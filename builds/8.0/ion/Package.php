...
final class Package implements PackageInterface
{
     ...
     */
    public static function create(string $vendor, string $project, bool $requireOnly = true, callable $loadingHandler = null, string $projectRootFile = null, SemVerInterface $version = null, int $requiredPhpMajorVersion = null, int $requiredPhpMinorVersion = null) : PackageInterface
    {
        return new static($vendor, $project, $requireOnly, $loadingHandler ?? function (PackageInterface $package) use($vendor, $project) : void {
        ...
        }, $projectRootFile ?? static::getCallingFile(), $version, $requiredPhpMajorVersion, $requiredPhpMinorVersion);
    }
    /**
     * 
    ...
    protected function __construct(string $vendor, string $project, bool $requireOnly, callable $loadingHandler, string $projectRootFile, SemVerInterface $version = null, int $requiredPhpMajorVersion = null, int $requiredPhpMinorVersion = null)
    {
